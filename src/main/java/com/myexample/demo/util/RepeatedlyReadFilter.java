...
//   			            if (element.getTagName().toLowerCase().equals("ns2:getdownlistbytaskcode")) {
//   			            	req = JSON.parseObject(element.getFirstChild().getTextContent(), new TypeReference<DownloadFileRequestVO>() {});
//   			            	break;
//   			            }
//   			        }
//   		            if(StringUtils.isEmpty(req.getAppkey()) || StringUtils.isEmpty(req.getAppkey())){
